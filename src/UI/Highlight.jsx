...
const StyledDiv = styled.div`
  ...
  background-image: radial-gradient(circle farthest-side at 20% 20%, var(${({primary}) => primary}), var(${({secondary}) => secondary})),
...
function Highlight({x, y, transition, opacity, primary, secondary, size, event, position}) {
  return (
    <StyledDiv
      x={x}
      y={y}
